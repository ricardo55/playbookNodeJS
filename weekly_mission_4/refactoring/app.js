...
// set the property trick and the value FIZZBUZZ, if is just divisible by 5 set the property 
// trick and the value BUZZ, if is just divisible by 3 set the property trick and the 
// value FIZZ, otherwise set the property trick and the score value. TODO
...
console.log(ExplorerService.filterByMission(explorers2, "node"));
console.log(ExplorerService.getAmountOfExplorersByMission(explorers2, "node"));
