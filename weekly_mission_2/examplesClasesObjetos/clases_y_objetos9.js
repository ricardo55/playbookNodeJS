...
class Developer {
  ...
  // Se usa la palabra extends para indicar que heredarás las propiedades de 
  // la clase Padre (Developer) en la clase definida.
  // Podemos definir una clase vacía y rehusar todos los componentes de la clase
  // padre
